...
This project publishes `snake-game-turn.html` as `index.html` and publishes `sw.js` beside it on the `gh-pages` branch.
...
replaces the published game files (`index.html`, `sw.js`, and `.nojekyll`), commits the result,
