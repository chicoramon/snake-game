...
const PRECACHE_ASSETS = [
  ...
  "./assets/branding/snakebit-logo.webp",
  "./assets/favicon-16x16-rbhnWYZq.png",
  "./assets/favicon-32x32-BIpU_scZ.png",
  "./assets/favicon-BxcpYJbg.ico",
  "./assets/fonts/pixel-operator-bold.ttf",
  "./assets/fonts/pixel-operator-license.txt",
  "./assets/fonts/pixel-operator.ttf",
  "./assets/fonts/upheaval-readme.txt",
  "./assets/fonts/upheaval.ttf",
  ...
  "./assets/index-DqmvurOp.css",
  "./assets/index-gZH_h2Ax.js",
  "./assets/manifest-BNDcFqH-.webmanifest",
  "./assets/snakebit-logo-D2o23a3m.webp",
  "./assets/social/og-image.jpg",
  "./assets/vs-battle-crest-DR2j8AP6.webp",
  "./assets/vs-lobby-arena-CKbABGfH.webp",
  "./assets/vs-room-settings-BO_yeKAS.png",
  "./assets/vs-rule-ghost-BgU_Jf9_.webp",
  "./assets/vs-rule-keyboard-SfyXYZCw.webp",
  "./assets/vs-rule-speed-CHaGuxf8.webp",
  "./assets/vs-rule-trophy-0LARowdu.webp",
  "./assets/vs/vs-battle-crest.webp",
  "./assets/vs/vs-lobby-arena.webp",
  "./assets/vs/vs-room-settings.png",
  "./assets/vs/vs-rule-ghost.webp",
  "./assets/vs/vs-rule-keyboard.webp",
  "./assets/vs/vs-rule-speed.webp",
  "./assets/vs/vs-rule-trophy.webp",
